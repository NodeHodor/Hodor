// const fs = require("fs");
var ejs = require("ejs");
// fs.writeFileSync("aaa.txt", "<% process.mainModule.require('fs').writeFileSync('./ejs-success.txt', '23'); %>");
// console.log(ejs.renderFile("aaa.txt", {}, (e, str) => { console.log(e);console.log(str);}));
...
//   test('consecutive tags work', function () {
    ejs.render(fixture('newlines.mixed.ejs'), {users: users})    
    ejs.render(fixture('consecutive-tags.ejs'))
...
//         '%>');
ejs.render('%%>')
ejs.render('  >', {}, {delimiter: ' '})
//     assert.equal(ejs.render('  >', {}, {delimiter: ' '}),
//         ' >');
//   });
// });
ejs.render(fixture('space-and-tab-slurp.ejs'), {users: users})
...
//   });
// });
ejs.render(fixture('rmWhitespace.ejs'), {}, {rmWhitespace: true})
...
ejs.render(fixture('include-simple.ejs'), {}, {filename: file})
...
ejs.render(fixture('include.ejs'), {pets: users}, {filename: file, delimiter: '@'})
...
// ejs.render(fixture('include-abspath.ejs'),
...
//   test('include ejs with set root path', function () {
    ...
    //     viewsPath = path.join(__dirname, 'fixtures');
        // ejs.render(fixture('include-root.ejs'), {pets: users}, {filename: file, delimiter: '@',root:viewsPath})
...
//   test('work when nested', function () {
    ...
    ejs.render(fixture('menu.ejs'), {pets: users}, {filename: file})
...
var file = 'test/fixtures/menu_var.ejs',
        ...
        ejs.render(fixture('menu.ejs'), {pets: users, varPath:  includePath}, {filename: file})
...
ejs.render(fixture('include.css.ejs'), {pets: users}, {filename: file})
...
//   test('work', function () {
    ...
    ejs.render(fixture('include_preprocessor.ejs'), {pets: users}, {filename: file, delimiter: '@'})
...
//       '<p>This is a file with BOM.</p>\n');
//   });
ejs.render(fixture('menu_preprocessor.ejs'), {pets: users}, {filename: file})
//   test('work when nested', function () {
...
//   });
ejs.compile(fixture('menu_preprocessor.ejs'), {filename: file})
...
//   });
ejs.render(fixture('include_preprocessor.css.ejs'), {pets: users}, {filename: file})
//   test('include arbitrary files as-is', function () {
