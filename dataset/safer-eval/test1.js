...
var noop = function () {}
// var describeBrowser = isBrowser ? describe : noop
// var describeNode = !isBrowser ? describe : noop
// var itBrowser = isBrowser ? it : noop
// var itNode = !isBrowser ? it : noop
...
//     it('tries to breakout', function () {
      var maliciousFunction = function () {
        var f = Buffer.prototype.write
        var ft = {
          length: 10,
          utf8Write () {
...
//     it('tries to break out yet another way using setInterval', function () {
//       var code = "Buffer.of.constructor('return" +
//         " process')().mainModule.require('child_process').execSync('whoami').toString();"
//       var res = saferEval(code)
//       assert.strictEqual(res, undefined)
//     })
